...
#define JAPANESE_NUMBERS "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇX"
#define JAPANESE_SPACE "Å@"
#define JAPANESE_DASH "Å|"
...
#define KOREAN_NUMBERS "£∞£±£≤£≥£¥£µ£∂£∑£∏£π"
#define KOREAN_SPACE "°°"
#define KOREAN_DASH "£≠"
#define KOREAN_DECODER KoreanDecoder

// Chinese Menu Text
#define CHINESE_MSG_SAVE_EXIST "%s%s°°%s‘¬%s»’%s ±%s∑÷"
#define CHINESE_MSG_SAVE_EMPTY "%s%s°°£≠£≠£≠£≠£≠£≠£≠£≠£≠£≠£≠£≠"
#define CHINESE_MSG_SAVE_CONFIRM "¥Ê¥¢¥Êµµ?°°%s%s?"
#define CHINESE_MSG_LOAD_CONFIRM "∂¡»°¥Êµµ?°°%s%s?"
#define CHINESE_MSG_RESET_CONFIRM "∑µªÿ±ÍÃ‚ΩÁ√Ê?"
#define CHINESE_MSG_END_CONFIRM "ÕÀ≥ˆ?"
#define CHINESE_MSG_YES " «"
#define CHINESE_MSG_NO "∑Ò"
#define CHINESE_MSG_OK "∫√µƒ"
#define CHINESE_MSG_CANCEL "»°œ˚"
#define CHINESE_SAVE_MENU_NAME "<¥Êµµ>"
#define CHINESE_LOAD_MENU_NAME "<∂¡»°>"
#define CHINESE_SAVE_ITEM_NAME "Œª"
#define CHINESE_NUMBERS "£∞£±£≤£≥£¥£µ£∂£∑£∏£π"
